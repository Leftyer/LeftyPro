...
var statisticsChart = echarts.init(document.getElementById('dataoverview'));
var statisticsOption;
var dataStatistics = {};
function statisticsDataFormatter(obj) {
...
dataStatistics.dataGDP = statisticsDataFormatter({
    //max : 60000,
...
dataStatistics.dataPI = statisticsDataFormatter({
    //max : 4000,
...
dataStatistics.dataSI = statisticsDataFormatter({
    //max : 26600,
...
dataStatistics.dataTI = statisticsDataFormatter({
    //max : 25000,
...
dataStatistics.dataEstate = statisticsDataFormatter({
    //max : 3600,
...
dataStatistics.dataFinancial = statisticsDataFormatter({
    //max : 3200,
    ...
    options: [
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2002'] },
                { data: dataStatistics.dataFinancial['2002'] },
                { data: dataStatistics.dataEstate['2002'] },
                { data: dataStatistics.dataPI['2002'] },
                { data: dataStatistics.dataSI['2002'] },
                { data: dataStatistics.dataTI['2002'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2002sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2002sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2002sum'] }
                    ]
                }
            ]
        },
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2003'] },
                { data: dataStatistics.dataFinancial['2003'] },
                { data: dataStatistics.dataEstate['2003'] },
                { data: dataStatistics.dataPI['2003'] },
                { data: dataStatistics.dataSI['2003'] },
                { data: dataStatistics.dataTI['2003'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2003sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2003sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2003sum'] }
                    ]
                }
            ]
        },
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2004'] },
                { data: dataStatistics.dataFinancial['2004'] },
                { data: dataStatistics.dataEstate['2004'] },
                { data: dataStatistics.dataPI['2004'] },
                { data: dataStatistics.dataSI['2004'] },
                { data: dataStatistics.dataTI['2004'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2004sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2004sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2004sum'] }
                    ]
                }
            ]
        },
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2005'] },
                { data: dataStatistics.dataFinancial['2005'] },
                { data: dataStatistics.dataEstate['2005'] },
                { data: dataStatistics.dataPI['2005'] },
                { data: dataStatistics.dataSI['2005'] },
                { data: dataStatistics.dataTI['2005'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2005sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2005sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2005sum'] }
                    ]
                }
            ]
        },
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2006'] },
                { data: dataStatistics.dataFinancial['2006'] },
                { data: dataStatistics.dataEstate['2006'] },
                { data: dataStatistics.dataPI['2006'] },
                { data: dataStatistics.dataSI['2006'] },
                { data: dataStatistics.dataTI['2006'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2006sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2006sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2006sum'] }
                    ]
                }
            ]
        },
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2007'] },
                { data: dataStatistics.dataFinancial['2007'] },
                { data: dataStatistics.dataEstate['2007'] },
                { data: dataStatistics.dataPI['2007'] },
                { data: dataStatistics.dataSI['2007'] },
                { data: dataStatistics.dataTI['2007'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2007sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2007sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2007sum'] }
                    ]
                }
            ]
        },
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2008'] },
                { data: dataStatistics.dataFinancial['2008'] },
                { data: dataStatistics.dataEstate['2008'] },
                { data: dataStatistics.dataPI['2008'] },
                { data: dataStatistics.dataSI['2008'] },
                { data: dataStatistics.dataTI['2008'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2008sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2008sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2008sum'] }
                    ]
                }
            ]
        },
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2009'] },
                { data: dataStatistics.dataFinancial['2009'] },
                { data: dataStatistics.dataEstate['2009'] },
                { data: dataStatistics.dataPI['2009'] },
                { data: dataStatistics.dataSI['2009'] },
                { data: dataStatistics.dataTI['2009'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2009sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2009sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2009sum'] }
                    ]
                }
            ]
        },
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2010'] },
                { data: dataStatistics.dataFinancial['2010'] },
                { data: dataStatistics.dataEstate['2010'] },
                { data: dataStatistics.dataPI['2010'] },
                { data: dataStatistics.dataSI['2010'] },
                { data: dataStatistics.dataTI['2010'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2010sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2010sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2010sum'] }
                    ]
                }
            ]
        },
        {
            ...
            series: [
                { data: dataStatistics.dataGDP['2011'] },
                { data: dataStatistics.dataFinancial['2011'] },
                { data: dataStatistics.dataEstate['2011'] },
                { data: dataStatistics.dataPI['2011'] },
                { data: dataStatistics.dataSI['2011'] },
                { data: dataStatistics.dataTI['2011'] },
                {
                    data: [
                        { name: '第一产业', value: dataStatistics.dataPI['2011sum'] },
                        { name: '第二产业', value: dataStatistics.dataSI['2011sum'] },
                        { name: '第三产业', value: dataStatistics.dataTI['2011sum'] }
                    ]
                }
            ]
        }
...
statisticsOption && statisticsChart.setOption(statisticsOption);
...
var mapChart = echarts.init(document.getElementById('dataMapViews'));
    ...
    // 地图散点图数据
    var mapData = [
        { name: "北京", value: 2 }, { name: "呼和浩特", value: 1 }, { name: "吉林", value: 1 }, { name: "上海", value: 1 }, { name: "成都", value: 2 },
